...
This project is indexed by GitNexus as **devremedia** (6407 symbols, 11859 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/devremedia/context` | Codebase overview, check index freshness |
| `gitnexus://repo/devremedia/clusters` | All functional areas |
| `gitnexus://repo/devremedia/processes` | All execution flows |
| `gitnexus://repo/devremedia/process/{name}` | Step-by-step execution trace |
